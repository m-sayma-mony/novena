                ...
                <div class="col-lg-12 testimonial-wrap-2">
                    <div class="testimonial-block style-2  gray-bg">
                        ...
                        <div class="testimonial-thumb">
                            <img src="{{ asset('/') }}assets/frontend/images/team/test-thumb1.jpg" alt=""
                                class="img-fluid">
                        </div>
                    ...
                    <div class="testimonial-block style-2  gray-bg">
                        <div class="testimonial-thumb">
                            <img src="{{ asset('/') }}assets/frontend/images/team/test-thumb2.jpg" alt=""
                                class="img-fluid">
                        </div>
                    ...
                    <div class="testimonial-block style-2  gray-bg">
                        <div class="testimonial-thumb">
                            <img src="{{ asset('/') }}assets/frontend/images/team/test-thumb3.jpg" alt=""
                                class="img-fluid">
                        </div>
                    ...
                    <div class="testimonial-block style-2  gray-bg">
                        <div class="testimonial-thumb">
                            <img src="{{ asset('/') }}assets/frontend/images/team/test-thumb4.jpg" alt=""
                                class="img-fluid">
                        </div>
    ...
    <section class="section clients">
        ...
        <div class="container">
            <div class="row clients-logo">
                ...
                <div class="col-lg-2">
                    <div class="client-thumb">
                        <img src="{{ asset('/') }}assets/frontend/images/about/2.png" alt=""
                            class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="client-thumb">
                        <img src="{{ asset('/') }}assets/frontend/images/about/3.png" alt=""
                            class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="client-thumb">
                        <img src="{{ asset('/') }}assets/frontend/images/about/4.png" alt=""
                            class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="client-thumb">
                        <img src="{{ asset('/') }}assets/frontend/images/about/5.png" alt=""
                            class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="client-thumb">
                        <img src="{{ asset('/') }}assets/frontend/images/about/6.png" alt=""
                            class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-2">
